...
@interface IWantViewController ()<UIScrollViewDelegate>
...
- (void)setupChildVc
{
    NearbyCarportViewController *social0 = [[NearbyCarportViewController alloc] init];
    social0.title = @"找车位";
    [self addChildViewController:social0];
    
    WantRentCarViewController *social1 = [[WantRentCarViewController alloc] init];
    social1.title = @"租车";
