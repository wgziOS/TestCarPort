...
- (UIColor *)hudBackgroundColor {
    ...
    if(_uiHudBgColor == nil) {
        _uiHudBgColor = [UIColor blackColor];
    }
...
- (UIColor *)hudForegroundColor {
    ...
    if(_uiHudFgColor == nil) {
        _uiHudFgColor = [UIColor whiteColor];
    }
...
#if __IPHONE_OS_VERSION_MIN_REQUIRED >= 70000
    return [UIImage imageNamed:@"SVProgressHUD.bundle/success-white"];
#else
    return [UIImage imageNamed:@"SVProgressHUD.bundle/success-black.png"];
#endif
}
...
#if __IPHONE_OS_VERSION_MIN_REQUIRED >= 70000
    return [UIImage imageNamed:@"SVProgressHUD.bundle/error-white"];
#else
    return [UIImage imageNamed:@"SVProgressHUD.bundle/error-black.png"];
#endif
}
