...
#define kAddImage @"cwcz-tjtp.png" // 添加按钮图片


#import "WGZaddImagesView.h"
@interface WGZaddImagesView()<UINavigationControllerDelegate, UIImagePickerControllerDelegate>
{
    // 标识被编辑的按钮 -1 为添加新的按钮
    NSInteger editTag;
}
...
@implementation WGZaddImagesView
